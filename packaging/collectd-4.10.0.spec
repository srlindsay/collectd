...
#%{_libdir}/collect/var/tmp/collectd-4.10.0-0el5.1-root/usr/lib64/collectd/ipmi.sod/memcached.so
...
%{_libdir}/collectd/aggregator.so
...
%{_libdir}/../share/collectd/types.db
